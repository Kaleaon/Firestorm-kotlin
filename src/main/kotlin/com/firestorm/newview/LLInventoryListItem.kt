...
abstract class LLPanelInventoryListItemBase(
    ...
    companion object {
        fun create(item: LLViewerInventoryItem?): LLPanelInventoryListItemBase? {
    ...
    fun getItem(): LLViewerInventoryItem? {
    ...
    private fun getIsItemFavorite(inv: LLViewerInventoryItem): Boolean {
        TODO("APR: use JVM equivalent - if item is link resolve linked object and check getIsFavorite(), else check item.getIsFavorite()")
    }
}
