...
object ExoFlickr {
    ...
    fun request(method: String, args: Map<String, Any?>, callback: ResponseCallback) {
        ...
        System.err.println("ExoFlickr: request not yet implemented")
    }
...
object SavedPerAccountSettings {
    fun getString(key: String): String { System.err.println("SavedPerAccountSettings: getString not yet implemented"); return "" }
    fun setString(key: String, value: String): Unit { System.err.println("SavedPerAccountSettings: setString not yet implemented") }
}
